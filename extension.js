...
export default {
  onload: ({ extensionAPI }) => {
    ...
    extensionAPI.ui.commandPalette.addCommand({
      ...
      callback: () => {
        ...
        fetchOblStrat("combined").then(string =>
          window.roamAlphaAPI.updateBlock({
            block: {
              uid: uid,
              string: string,
    ...
    extensionAPI.ui.commandPalette.addCommand({
      label: "Random Oblique Strategy - 1st Edition",
      callback: () => {
        const uid = window.roamAlphaAPI.ui.getFocusedBlock()?.["block-uid"];
        if (uid == undefined) {
          alert("Please focus a block before importing a quote");
    ...
    extensionAPI.ui.commandPalette.addCommand({
      label: "Random Oblique Strategy - 2nd Edition",
      callback: () => {
        const uid = window.roamAlphaAPI.ui.getFocusedBlock()?.["block-uid"];
        if (uid == undefined) {
          alert("Please focus a block before importing a quote");
    ...
    extensionAPI.ui.commandPalette.addCommand({
      label: "Random Oblique Strategy - 3rd Edition",
      callback: () => {
        const uid = window.roamAlphaAPI.ui.getFocusedBlock()?.["block-uid"];
        if (uid == undefined) {
          alert("Please focus a block before importing a quote");
    ...
    extensionAPI.ui.commandPalette.addCommand({
      label: "Random Oblique Strategy - 4th Edition",
      callback: () => {
        const uid = window.roamAlphaAPI.ui.getFocusedBlock()?.["block-uid"];
        if (uid == undefined) {
          alert("Please focus a block before importing a quote");
    ...
    extensionAPI.ui.commandPalette.addCommand({
      label: "Random Oblique Strategy - 5th Edition",
      callback: () => {
        const uid = window.roamAlphaAPI.ui.getFocusedBlock()?.["block-uid"];
        if (uid == undefined) {
          alert("Please focus a block before importing a quote");
    ...
    const args = {
      text: "OBLIQUESTRATEGYRANDOM",
      help: "Draw a Random Oblique Strategy",
      handler: (context) => fetchOblStratC,
    };
    const args1 = {
      text: "OBLIQUESTRATEGYED1",
      help: "Draw a Random Oblique Strategy from 1st Edition",
      handler: (context) => fetchOblStrat1,
    };
    const args2 = {
      text: "OBLIQUESTRATEGYED2",
      help: "Draw a Random Oblique Strategy from 2nd Edition",
      handler: (context) => fetchOblStrat2,
    };
    const args3 = {
      text: "OBLIQUESTRATEGYED3",
      help: "Draw a Random Oblique Strategy from 3rd Edition",
      handler: (context) => fetchOblStrat3,
    };
    const args4 = {
      text: "OBLIQUESTRATEGYED4",
      help: "Draw a Random Oblique Strategy from 4th Edition",
      handler: (context) => fetchOblStrat4,
    };
    const args5 = {
      text: "OBLIQUESTRATEGYED5",
      help: "Draw a Random Oblique Strategy from 5th Edition",
      handler: (context) => fetchOblStrat5,
    };
  ...
  onunload: () => {
    if (window.roamjs?.extension?.smartblocks) {
      window.roamjs.extension.smartblocks.unregisterCommand("OBLIQUESTRATEGYRANDOM");
      window.roamjs.extension.smartblocks.unregisterCommand("OBLIQUESTRATEGYED1");
      window.roamjs.extension.smartblocks.unregisterCommand("OBLIQUESTRATEGYED2");
      window.roamjs.extension.smartblocks.unregisterCommand("OBLIQUESTRATEGYED3");
      window.roamjs.extension.smartblocks.unregisterCommand("OBLIQUESTRATEGYED4");
      window.roamjs.extension.smartblocks.unregisterCommand("OBLIQUESTRATEGYED5");      
    }
  }
}
...
async function fetchOblStratC() {
  return fetchOblStrat("combined");
}

async function fetchOblStrat1() {
  return fetchOblStrat("1");
}

async function fetchOblStrat2() {
  return fetchOblStrat("2");
}

async function fetchOblStrat3() {
  return fetchOblStrat("3");
}

async function fetchOblStrat4() {
  return fetchOblStrat("4");
}

async function fetchOblStrat5() {
  return fetchOblStrat("5");
}